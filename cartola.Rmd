...
gov_s<-gov%>%
  select(poder,org_max,org,uf,ug,ug_cod, receita, despesa, resultado)

datatable(gov_s, filter = 'top', options = list(  pageLength = 5, autoWidth = TRUE, style = "default", width = 1200))
