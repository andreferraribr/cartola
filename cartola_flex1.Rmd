...
colnames(gov)<- c("poder_cod","poder","org_max_cod","org_max","org_sup_cod","org_sup", "org_cod","grupo","uf","uf_nome","muni_cod","muni","ug_cod","ug","despesa","receita","resultado")
...
datatable(cartola_s%>%  select(nome, uf, receita, despesa, resultado),
